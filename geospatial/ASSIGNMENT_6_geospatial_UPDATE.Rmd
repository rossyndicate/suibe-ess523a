...
- Add the China country boundary as an overlay
...
Calculate the mean projected temperature change for each province using the `zonal()` function. Add the values as a new column to your china boundary data.
